...
export class ProductService {
    private baseUrl = '/src/api/products/products.json';
   //http://localhost:4200/src/api/products/products.json
    ...
    //  getBooksAndMovies(): Observable<any> {
    // return  this.http.get('/app/products.json').map((res:Response) => res.json())
